...
- Реалізовано клас `Comment` для ієрархічної системи коментарів
- Підтримує вкладені відповіді з необмеженою глибиною
- Методи: `add_reply()`, `remove_reply()`, `display()`
- Рекурсивне відображення з відступами для візуалізації структури
